...
$GLOBALS['TCA']['pages']['columns'] = array_replace_recursive(
    ...
    [
        'nav_icon' => [
            'exclude' => true,
            'label' => 'LLL:EXT:starterkit/Resources/Private/Language/Backend.xlf:pages.nav_icon',
        ...
        'thumbnail' => [
            'exclude' => true,
            'label' => 'LLL:EXT:starterkit/Resources/Private/Language/Backend.xlf:pages.thumbnail',
            'config' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::getFileFieldTCAConfig(
                'thumbnail',
                [
                    'appearance' => [
